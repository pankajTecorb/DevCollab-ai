export const errors = {
    en: {
        ...
        "adminWithSameEmail": "Admin with Email:{{email}}, already exist. Please try with other one",
        "emailExist": "This Email:{{email}}, already exist. Please try with other one",
        "noSuchAccount": "No such account exist with Email:{{email}}.",
